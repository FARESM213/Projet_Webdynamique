  ...
  <body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-2">
          <div class="col d-flex justify-content-center">
            ...
            <div>
              ...
              <input type="Email" name="Emaillog"  placeholder="fares.messaoudi@edu.ece.Fr" required>
        ...
        <div class="row mb-2">
          ...
          <input type="password" name="Mdplog" id="Mdplog" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,16}$">
          ...
          <div class="col d-flex justify-content-center">
            <div>
              ...
              <input type="radio" name="Genre" value="patient" checked="checked"> <label>Patient </label>
              <input type="radio" name="Genre" value="Admin"> <label>Admin </label>
